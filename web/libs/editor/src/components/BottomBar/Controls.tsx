...
export const EMPTY_SUBMIT_TOOLTIP = "此项目不允许提交空标注";
export const INCOMPLETE_SUBMIT_TOOLTIP = "提交前请完成所有区域";
export const INCOMPLETE_UPDATE_TOOLTIP = "更新前请完成所有区域";
export const INCOMPLETE_ACCEPT_TOOLTIP = "接受前请完成所有区域";
