          ...
          {usersList ? (
            <div className={cn("people-list").elem("users").toClassName()}>
              <div className={cn("people-list").elem("header").toClassName()}>
                ...
                <div className={cn("people-list").elem("column").mix("email").toClassName()}>{t("peoplePage.email")}</div>
                <div className={cn("people-list").elem("column").mix("name").toClassName()}>{t("peoplePage.name")}</div>
                <div className={cn("people-list").elem("column").mix("last-activity").toClassName()}>{t("peoplePage.lastActivity")}</div>
              </div>
                  ...
                  return (
                    ...
                    >
                      <div className={cn("people-list").elem("field").mix("avatar").toClassName()}>
                        <CopyableTooltip title={t("peoplePage.userId", { id: user.id })} textForCopy={user.id}>
