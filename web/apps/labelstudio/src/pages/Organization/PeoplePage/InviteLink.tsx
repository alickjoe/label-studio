...
export function InviteLink({
  ...
  return (
    <Modal
      ref={modalRef}
      title={t("peoplePage.inviteMembers")}
      opened={opened}
      bareFooter={true}
  ...
  return (
    <div className={cn("invite").toClassName()}>
      ...
      <Typography size="small" className="text-neutral-content-subtler mt-base mb-wider">
        {t("peoplePage.inviteDescription")}{" "}
        <a
    ...
    <Space spread>
      <Space>
        <Button
          ...
          style={{ width: 170 }}
          onClick={() => refetch()}
          aria-label={t("peoplePage.refreshInviteLink")}
        >
          {t("peoplePage.resetLink")}
        </Button>
      </Space>
      <Space>
        <Button
          ...
          aria-label={t("peoplePage.copyInviteLink")}
        >
          {copied ? t("peoplePage.copied") : t("peoplePage.copyLink")}
        </Button>
      </Space>
    </Space>
  );
